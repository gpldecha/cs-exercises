...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores = out_layer2
        # loss, dx = softmax_loss(out_layer2, y)
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dout2, dw2, db2 = affine_relu_backward(dout, cache_layer2)
        dout1, dw1, db1 = affine_relu_backward(dout2, cache_layer1)
        grads['b1'] = db1
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        self.params['W' + str(num_hidden_layers+1)] = weight_scale*np.random.randn(hidden_dims[-1], num_classes)
    ...
    def loss(self, X, y=None):
        ...
        sum_squares_of_w = 0.0
        for i in range(self.num_layers):
            sum_squares_of_w += np.sum(self.params['W'+str(i+1)]**2)
