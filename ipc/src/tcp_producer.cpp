...
// https://www.boost.org/doc/libs/1_50_0/doc/html/boost_asio/example/timeouts/server.cpp
...
int main(){
    ...
    try{
        ...
        tcp::endpoint listen_endpoint(tcp::v4(), 6066);
        udp::endpoint broadcast_endpoint(udp::v4(), 6066);
